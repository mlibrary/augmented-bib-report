class ReportGenerator
  ...
  def run
    output = [["barcode", "mms_id", "title", "author", "call number", "inventory number", "item description", "oclc numbers", "HathiTrust items", "other electronic items", "Total Libraries", "United States Libraries", "Libraries Outside of the United States"]]
